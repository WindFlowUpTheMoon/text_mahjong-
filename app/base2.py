...
class Player:
    ...
    def kind_check(self, hand_cards, pgcards, angang_num, lastcard = None):
        ...
        # 清一色
        if all_num[-1] < 31 and all_num[-1] - all_num[0] < 9:
            kinds.append('清一色')
        ...
        # 三同刻
        l = [k for k, v in c_numlist.items() if v == 3] + [k for k, v in c_pg.items() if v in (3, 4)]
...
if __name__ == '__main__':
    ...
    hc = {'筒': [1,2,3,4,5,5,5,6,6,6,7,7], '条': [11,11,], '万': [], '字': [], '花': []}
