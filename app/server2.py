...
from app.config import KIND_VALUE_MAP, HAIDILAOYUE, TIANHU, DIHU
...
class GameServer:
    ...
    def init_start(self):
        ...
        self.table_cards=['1条','1条','1条','8条','8条','6筒','东风','8条','西风','西风',]
        p1,p2,p3 = self.players
        p1.hand_cards = {'筒子': ['2筒','2筒','3筒','4筒','4筒','5筒','7筒',], '条子': ['3条','3条','7条', '7条', '8条'], '万字': ['3万'],
                  '字牌': ['北风'], '花牌': []}
